    ...
    Column(
        ...
        Row(
            ...
            Text(
                ...
                modifier = Modifier.testTag("inputPersonas")
            )
        ...
        Row(
            ...
            Checkbox(
                ...
                modifier = Modifier.testTag("switchRedondear")
            )
        ...
        Text(
            ...
            modifier = Modifier.testTag("textoPropina")
        )

        Text(
            text = "Total por persona: $${"%.2f".format(totalPerPerson)}",
            style = MaterialTheme.typography.headlineSmall,
            modifier = Modifier.testTag("textoTotal")
        )
    }
}
